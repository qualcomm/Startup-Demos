  ...
  <tr>
    ...
    <td>
      ...
      <a href="./GenAI/CloudAI-Playground/online_server_endpoint_stream/" title="Online service server endpoint with streaming support (stream=true) using Llama 3.3 70B 32K ctx_len on AIC100 Ultra.">
        <img src="https://img.shields.io/badge/Online_server_endpoint_stream-2026.03.11-grey?style=flat-square&labelColor=brightgreen" alt="Online server endpoint stream"/>
      </a><br>
      <a href="./GenAI/CloudAI-Playground/traffic_ai_agent/" title="An on‑prem traffic AI demo with real‑time decisions and LLM explanations on Cloud AI 100 Ultra.">
        <img src="https://img.shields.io/badge/Traffic_AI_Agent_–_Dual_Intersection_(On‑Prem,_Analysis)-2026.03.09-grey?style=flat-square&labelColor=brightgreen" alt="Traffic AI Agent – Dual Intersection (On‑Prem, Analysis)"/>
      </a>
    </td>
    <td align="center">—</td>
    <td align="center">—</td>
