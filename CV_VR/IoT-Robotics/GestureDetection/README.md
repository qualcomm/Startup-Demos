...
- [4. Gesture Detection Workflow](#4-gesture-detection-workflow)
...
- [7. Prepare the Application](#7-prepare-the-application)
  - [7.1 Copy Exisiting Video Detection on camera Application](#71-copy-exisiting-video-detection-on-camera-application)
...
- [8. Run the Gesture Detection application](#8-run-the-gesture-detection-application)
...
![N|Solid](Images/uno_q_gesture_detection_schematic.png)
...
### 7.1 Copy Exisiting Video Detection on camera Application
...
## 8. Run the Gesture Detection application
...
### 8.1 Demo Output
  ...
  ![N|Solid](Images/uno_q_gesture_app_output.gif)
